...
type GetCustomDocumentRes struct {
	...
	Document  *CustomDocument       `protobuf:"bytes,2,opt,name=document,proto3" json:"document,omitempty"`
}
...
func (x *GetCustomDocumentRes) GetDocument() *CustomDocument {
	if x != nil {
		return x.Document
	}
	return nil
...
type ListCustomDocumentsRes struct {
	...
	CommonRes *idl_common.CommonRes `protobuf:"bytes,1,opt,name=commonRes,proto3" json:"commonRes,omitempty"`
	Documents []*CustomDocument     `protobuf:"bytes,2,rep,name=documents,proto3" json:"documents,omitempty"`
}
...
func (x *ListCustomDocumentsRes) GetDocuments() []*CustomDocument {
	if x != nil {
		return x.Documents
	}
	return nil
...
func (x *DesiredCustomDocumentReq) GetDocument() *CustomDocument {
	if x != nil {
		return x.Document
	}
	return nil
...
var file_documents_custom_proto_rawDesc = []byte{
	...
	0x40, 0x0a, 0x08, 0x64, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28,
...
var file_documents_custom_proto_depIdxs = []int32{
	...
	0,  // 2: redfox.api.documents.GetCustomDocumentRes.document:type_name -> redfox.api.documents.CustomDocument
	5,  // 3: redfox.api.documents.ListCustomDocumentsRes.commonRes:type_name -> redfox.api.idl_common.CommonRes
	0,  // 4: redfox.api.documents.ListCustomDocumentsRes.documents:type_name -> redfox.api.documents.CustomDocument
	6,  // 5: redfox.api.documents.DesiredCustomDocumentReq.commonRes:type_name -> redfox.api.idl_common.CommonReq
	0,  // 6: redfox.api.documents.DesiredCustomDocumentReq.document:type_name -> redfox.api.documents.CustomDocument
